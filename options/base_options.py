...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--scaled_width', type=int,
                            default=1248, help='input width of the model')
        parser.add_argument('--scaled_height', type=int,
                            default=384, help='input height of the model')
        parser.add_argument(
        ...
        parser.add_argument('--normalization', default='imagenet',
                            help='normalization type: imagenet, default (1/255)')
        ...
        parser.add_argument('--gpus', type=str, default='0',
                            help='gpu ids for training, testing. e.g. 0 or 0,1,2')
        parser.add_argument('--accelerator', type=str, default='ddp',
                            help='DataParallel (dp), DistributedDataParallel (ddp)')
